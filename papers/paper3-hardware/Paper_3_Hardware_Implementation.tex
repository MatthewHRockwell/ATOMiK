...
The delta-state algebra $(\Delta, \dcompose, \dzero)$ operates on 64-bit vectors with XOR composition. The following properties, proven via 92 Lean4 theorems with zero \texttt{sorry} statements, directly inform hardware design:
...
% Stages
\node[stage] (proofs)  at (0, 6.5) {Lean4 Proofs\\92 theorems, 0 sorry};
...
We have presented the complete hardware implementation of \atomik{}, spanning three generations of FPGA designs, demonstrating the practical translation of 92 formally verified theorems into production silicon.
