...
- **Security-related claims require separate threat-model review.** The dynamic reference-state model may support useful integrity or verification patterns, but this document should not be used to claim Spectre/Meltdown immunity, information-theoretic security, or broad side-channel protection. Formal proof work and hardware validation artifacts cover specific algebraic and implementation properties; public security claims need their own artifact, caveat, and reviewed threat model.
