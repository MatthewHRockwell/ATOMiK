...
Version manifest: `CHECKSUMS.md` records SHA-256 hashes for this send folder. Regenerate it after any package change.
...
- Product/technical overview and investor-safe patent summary; the full provisional patent PDF is not included in the default send folder and is kept under `business/friday_restricted/` for counsel/NDA-controlled access
