...
> approved signed financing term sheet. The current Aggie-facing ask is $5M; final
...
| Seed deal-size benchmark | PitchBook/NVCA Q1 2026 shows median U.S. VC seed deal value of $3.0M. | Useful context only; the Aggie-facing $5M ask is tied to hardware/IP proof gates and prior expectation, not generic median seed sizing. |
...
|---|---:|---|---|
| Staged close | $3.0M | ~18 months | Proof, IP conversion, demo hardening, and first measured workload evaluations. |
| Target raise | $5.0M | ~24 months | Aggie-facing live ask: customer proof, IP strengthening, ASIC feasibility, technical capacity, and operating readiness. |
| Expanded plan | $7.5M | ~24 months at broader validation capacity | Faster hiring and deeper evaluation/ASIC feasibility support without claiming tape-out. |

Planned default instrument: SAFE structure, pending CFO/counsel review. Valuation cap, discount,
pro-rata rights, option-pool mechanics, and close mechanics should be set by the fractional CFO and
counsel.
...
- Use the $5M target ask in the Aggie room because that is the prior expectation, while keeping final SAFE mechanics CFO/counsel pending. Do not publish a valuation cap or priced-round valuation until
  CFO-reviewed.
...
1. Approve or revise the $5M target ask and SAFE structure.
...
|---|---:|---:|---:|---:|---:|---:|
| Target | $5.0M | $400K | $4.60M | 18-24 months | ~$208K-$278K/mo | ~$192K-$256K/mo |
...
This is not a valuation recommendation. It shows simple ownership sold under illustrative SAFE cap math before option pool, prior instruments, side letters, and priced-round mechanics.

| Illustrative post-money cap | $5M target |
|---:|---:|---:|---:|
| $8M | 15.6% | 25.0% | 34.4% |
| $10M | 12.5% | 20.0% | 27.5% |
| $12M | 10.4% | 16.7% | 22.9% |
...
### Workbook Governance Additions

The workbook now includes a first-tab README Model Map that states the model version/date, owner, intended use, advice disclaimer, key assumptions, investor-facing vs internal tabs, source-register pointer, and open diligence gaps. This is meant to make the workbook easier for CFO/counsel review and prevent accidental over-distribution.

### Unmodeled CFO Estimate Needed

The workbook includes a visible diligence tab for items that require CFO/accounting/counsel estimates before final model distribution: payroll taxes, benefits, D&O/general liability/cyber insurance, accounting/bookkeeping/tax, Delaware C-Corp conversion or formation costs, legal close costs, IP prosecution variability, FPGA/dev-board/tooling variability, cloud/dev infrastructure, travel/customer support, and contingency beyond the $400K reserve.

### Evaluation SOW Economics - Planning Only

The workbook includes a planning-only SOW economics tab. It does not forecast revenue. It lays out what a real SOW would need to define: workload intake, baseline mapping, success metric definition, test harness/artifact creation, readout and fit/no-fit recommendation, optional partner-funded proof work, scoped pricing, and accounting treatment.

## Source Register

Use these sources as context only. They do not prove ATOMiK savings, valuation, revenue, customer traction, or tape-out readiness.
...
### Program / accelerator comparison
