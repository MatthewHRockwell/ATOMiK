...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/ai-demo`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/blog`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/blog/what-is-delta-state-computing`, lastModified: new Date("2026-03-16"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/blog/crdt-alternative-delta-state`, lastModified: new Date("2026-03-16"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${baseUrl}/solutions/database-sync`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${baseUrl}/blog/5-patterns-delta-state`, lastModified: new Date("2026-03-16"), changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/benchmarks`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
