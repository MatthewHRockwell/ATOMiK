...
const tiers = [
  {
    ...
    features: [
      { text: "Python SDK (atomik-core)", included: true },
      { text: "C99 header (atomik_core.h)", included: true },
      { text: "JavaScript SDK (@atomik/core)", included: true },
  ...
  return (
    <div className="min-h-screen" style={{ background: "#0a0a0f", color: "#e0e0e8" }}>
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        ...
        >
          <table className="w-full text-sm" style={{ minWidth: "640px" }}>
            ...
            <tbody>
              {[
                ["Python SDK + C99 header + JavaScript SDK", true, true, true, true],
                ...
                ["atomik-bench performance suite", false, true, true, true],
                ...
                ["Custom RV64I CPU + ATOMiK ISA extensions", false, false, false, true],
                ["Formal verification certificate", false, false, false, true],
                ["ASIC development path", false, false, false, true],
      ...
      <section className="max-w-5xl mx-auto px-6 py-12 pb-24">
        <h2 className="text-2xl font-bold text-center tracking-tight mb-2">Trusted Technology</h2>
        <p className="text-center text-sm mb-8" style={{ color: "#8888a0" }}>
          Real engineering milestones behind every tier.
        </p>
