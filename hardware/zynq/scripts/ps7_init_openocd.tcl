# OpenOCD helper: read memory word
proc mrw {addr} {
    set result [read_memory $addr 32 1]
    return [lindex $result 0]
}
# ps7_init.tcl for RK-ZYNQ7020-F — REAL board config from buildroot
...
proc ps7_peripherals_init {} {
    ...
    # PS_CLK=32.214MHz → ref=96.642MHz. 115200: ref/(7*120)=115050 (0.13%)
    mask_write 0xE0000034 0x000000FF 0x00000077
    mask_write 0xE0000018 0x0000FFFF 0x00000007
